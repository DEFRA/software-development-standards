...
To apply these settings must also globally across all projects on your machine, run the following commands to ensure you are protected from any repository you interact with, even if you don't own it.
