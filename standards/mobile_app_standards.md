...
There are other recommendations to also bear in mind, especially around the security of data on the device and authentication strategies, so you are strongly advised to also read the accompanying **\[guidance\](/guides/mobile\_app\_guidance.md)** on mobile app development alongside these standards.
